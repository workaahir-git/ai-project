        ...
        try:
            resp = await client.post(
                ...
                json={
                    ...
                    # output tokens on Gemini; 8000 comfortably covers the full
            ...
            raise RuntimeError("Could not reach Gemini API. Check your API key.")
            ...
            raise RuntimeError(
                f"G API returned an error ({e.response.status_code}): "
